...
from hshadow import eventloop, shell, common
from hshadow.common import parse_header, onetimeauth_verify, \
    onetimeauth_gen, ONETIMEAUTH_BYTES, ONETIMEAUTH_CHUNK_BYTES, \
    ONETIMEAUTH_CHUNK_DATA_LEN, ADDRTYPE_AUTH
from hshadow.easy import En,De
...
class TCPRelayHandler(object):
    ...
    def __init__(self, server, fd_to_handlers, loop, local_sock, config,
        ...
        self._cryptor = cryptor() #cryptor.Cryptor(config['password'],
                         #               config['method'],
                          #              config['crypto_path'])
